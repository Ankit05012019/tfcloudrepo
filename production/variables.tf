...
variable "public_subnets" {
  ...
  default     = {
    ...
    us-east-1a = "10.16.16.0/20",
    us-east-1b = "10.16.32.0/20",
    us-east-1c = "10.16.48.0/20"  
...
variable "private_subnets_app" {
  ...
  default     = {
    ...
    us-east-1a = "10.16.128.0/20",
    us-east-1b = "10.16.64.0/20",
    us-east-1c = "10.16.96.0/20"
...
variable "private_subnets_db" {
  ...
  default     = {
    ...
    us-east-1a = "10.16.80.0/24",
    us-east-1b = "10.16.112.0/24",
    us-east-1c = "10.16.144.0/24"
